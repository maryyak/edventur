Отлично, я подготовлю руководство по эксплуатации проекта [edventur](https://github.com/maryyak/edventur), включающее:

* Порядок работы с приложением
* Функциональное назначение команд меню
* Структуру и функциональное назначение пользовательских интерфейсов со скриншотами всех экранов

Я изучу репозиторий и вернусь с полным документом, оформленным как руководство пользователя.
...
**Важно:** Если на каких-то экранах не видны ожидаемые элементы (например, кнопки для создания/удаления), это может означать, что соответствующий функционал пока не реализован. Следите за уведомлениями разработчиков о полном запуске всех функций.

**Вывод:** представленное выше описание основано на текущих разработках проекта. Некоторые разделы (например, интеграция с Сбер АПИ или полная база данных) могут находиться в стадии доработки. Тем не менее основная логика интерфейса и переходов описана максимально полно для конечного пользователя.
