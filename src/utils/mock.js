...
export const userInfo = {
    ...
    score: '4.5',
    role: 'student',
    assessments: [3] // тут многие ко многим с ассессментами, может быть пустое, храним здесь пройденные ассессменты
};
...
export const programs = [
    {
        ...
        similarity: 0.8,
        min_similarity: 0.8,
        assessment: 1, // тут связь один ко многим с таблицей ассессментов, поле необязательное
        studyplan: {
